...
export const defaultConfig: Config = {
  api: {
    ...
    newKycUrl: "/api/v2/newKyc/admin",
    bannerUrl: "/api/v2/banner",
    profitUrl: "/api/v2/profit/admin",
...
//hot custome env
Cryptobase.config.api.competitionUrl =
  Cryptobase.config.api.competitionUrl || "/api/v2/competition";
Cryptobase.config.api.airdropUrl =
  Cryptobase.config.api.airdropUrl || "/api/v2/airdrop";
Cryptobase.config.api.sunshineUrl =
  Cryptobase.config.api.sunshineUrl || "/api/v2/sunshine";
Cryptobase.config.api.stakeUrl =
  Cryptobase.config.api.stakeUrl || "/api/v2/stake";
Cryptobase.config.api.ieoAPIUrl =
  Cryptobase.config.api.ieoAPIUrl || "/api/v2/ieo";
Cryptobase.config.api.walletUrl =
  Cryptobase.config.api.walletUrl || "/api/v2/wallet";
Cryptobase.config.api.referralUrl =
  Cryptobase.config.api.referralUrl || "/api/v2/referral";
Cryptobase.config.api.transactionUrl =
  Cryptobase.config.api.transactionUrl || "/api/v2/transaction";
Cryptobase.config.api.statisticUrl =
  Cryptobase.config.api.statisticUrl || "/api/v2/statistic";
Cryptobase.config.api.newKycUrl =
  Cryptobase.config.api.newKycUrl || "/api/v2/newKyc";
Cryptobase.config.api.withdrawLimitUrl =
  Cryptobase.config.api.withdrawLimitUrl || "/api/v2/withdrawLimit";
Cryptobase.config.api.paypalUrl =
  Cryptobase.config.api.paypalUrl || "/api/v2/paypal";

Cryptobase.config.api.profitUrl =
  Cryptobase.config.api.profitUrl || "/api/v2/profit/admin";
//end custome env
...
export const profitUrl = () => Cryptobase.config.api.profitUrl;
...
export const minutesUntilAutoLogout = (): string =>
  Cryptobase.config.minutesUntilAutoLogout || "5";
export const withCredentials = () => Cryptobase.config.withCredentials;
export const defaultStorageLimit = () =>
  Cryptobase.config.storage.defaultStorageLimit || STORAGE_DEFAULT_LIMIT;
export const orderBookSideLimit = () =>
  Cryptobase.config.storage.orderBookSideLimit || ORDER_BOOK_DEFAULT_SIDE_LIMIT;
export const gaTrackerKey = (): string => Cryptobase.config.gaTrackerKey || "";
export const msAlertDisplayTime = (): string =>
  Cryptobase.config.msAlertDisplayTime || "5000";
export const rangerReconnectPeriod = (): number =>
  Cryptobase.config.rangerReconnectPeriod
    ? Number(Cryptobase.config.rangerReconnectPeriod)
    : 1;
export const incrementalOrderBook = (): boolean =>
  Cryptobase.config.incrementalOrderBook || false;
export const isResizableGrid = (): boolean =>
  Cryptobase.config.isResizable || false;
export const isDraggableGrid = (): boolean =>
  Cryptobase.config.isDraggable || false;
export const languages =
  Cryptobase.config.languages && Cryptobase.config.languages.length > 0
    ? Cryptobase.config.languages
    : ["mn"];
export const sessionCheckInterval = (): string =>
  Cryptobase.config.sessionCheckInterval || "15000";
export const balancesFetchInterval = (): string =>
  "5000" || Cryptobase.config.balancesFetchInterval;
export const isFinexEnabled = (): boolean => Cryptobase.config.finex || false;
export const passwordEntropyStep = (): number =>
  Cryptobase.config.passwordEntropyStep;
export const showLanding = (): boolean => Cryptobase.config.showLanding;
export const sentryEnabled = () =>
  Cryptobase.config.sentryEnabled || defaultConfig.sentryEnabled;
export const kycSteps = (): string[] =>
  Cryptobase.config.kycSteps || DEFAULT_KYC_STEPS;
